...
;; Target RejectNegative Joined Enum(target_device) Init(unk_device)
;;S pecify the target CPU.

m10
Target RejectNegative Negative(mbm1)
Generate code for an 11/10.

mbm1
Target RejectNegative Mask(BM1) Negative(mbm2) InverseMask(FPU)
Generate code for Soviet 1801BM1

mbm2
Target RejectNegative Mask(BM2) Negative(m40) InverseMask(FPU)
Generate code for Soviet 1801BM2.

m40
Target Mask(40) Negative(m45)
Generate code for an 11/40.

m45
Target Mask(45) Negative(m10)
